...
module DiscoursePatreonDonations
  class PatreonCampaignDiscovery
    def self.discover_and_save
      ...
      return false unless SiteSetting.patreon_campaign_url.present?

      client = PatreonApiClient.new
      campaign_id = client.discover_campaign_id(SiteSetting.patreon_campaign_url)
      ...
      if campaign_id.present?
        ...
        Rails.logger.error("Failed to auto-discover Patreon campaign ID from URL: #{SiteSetting.patreon_campaign_url}")
        false
      end
